var CollisionDetection = (function() {
   var circleCollide = function(x1, y1, r1, x2, y2, r2) {
    ...
    var testCollisionWithWalls = function(w, h, gameAreaBorder, ball) {
      // left
    ...
    var ballBrickCollisionSides = function(ball, brick) {
    ...
    var resetBallAfterBrickCollision = function(ball, brick) {
    ...
    return {
      ...
      testCollisionWithWalls: testCollisionWithWalls,
      resetBallAfterBrickCollision: resetBallAfterBrickCollision
    };
})();
